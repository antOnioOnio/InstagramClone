...
public class Heart {
    ...
    private static final DecelerateInterpolator DECCELARATE_INTERPOLATOR = new DecelerateInterpolator();
    ...
    public void toggleLike(){
        ...
        if(heartRed.getVisibility() == View.VISIBLE){
            ...
            scaleDownY.setDuration(300);
            scaleDownY.setInterpolator(DECCELARATE_INTERPOLATOR);

            ObjectAnimator scaleDownX = ObjectAnimator.ofFloat(heartRed, "scaleX", 0.1f, 1f);
            scaleDownX.setDuration(300);
            scaleDownX.setInterpolator(DECCELARATE_INTERPOLATOR);
